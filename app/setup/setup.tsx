...
export function OwnerSetup(){
  ...
  return source?<iframe title="Create your ME owner account" src={source} referrerPolicy="no-referrer" className="min-h-[850px] w-full rounded-lg border border-line"/>:<p className="text-muted">Open the private owner setup link provided on your desktop.</p>;
}
