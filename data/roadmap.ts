...
export const milestones: Milestone[] = [
  ...
  },
  {
    ...
    state: "Long term",
    tier: "LONG-TERM",
    detail: "Factorio does not run on ME OS. No Linux system calls, no ELF loading, no memory allocator, no processes.",
  },
  {
    id: "holo-m1",
  ...
  },
  {
    id: "holo-m8",
    project: "Holoprojector",
    title: "M8: physical backend protocol design",
    state: "Planned",
    tier: "PLANNED",
    detail: "What a real projector would be sent, written down. No hardware control code.",
  },
  {
    id: "holo-m9",
    project: "Holoprojector",
    title: "M9: hardware integration",
    state: "Long term",
    tier: "LONG-TERM",
    detail: "Gated behind an independent safety review. Nothing has been built and nothing is scheduled.",
  },
  {
    id: "carl-panel-v1",
    project: "Carl",
    ...
    state: "Complete",
    detail: "Event ordering proved against the real binaries. It runs on one machine.",
  },
  {
  ...
  },
  {
    id: "carl-room",
    project: "Carl",
    title: "A shared room for people and agents",
    state: "Complete",
    detail: "One record both read. A name is earned by a password and cannot be chosen.",
  },
  {
    id: "carl-deployment",
    project: "Carl",
  ...
  },
  {
    ...
    state: "Complete",
    detail: "Agents outlive the daemon. A pid plus its start time, so recovery never adopts a stranger.",
  },
  {
    id: "aos-daemon",
    project: "AOS",
    title: "The daemon, and adopting orphans",
    state: "Complete",
    detail: "Checked over a real socket, against genuinely orphaned processes.",
  },
  {
    id: "aos-policy",
    project: "AOS",
    ...
    state: "Complete",
    detail: "What may run, and what needs a commit first. Refusals are recorded too.",
  },
  {
    id: "aos-files",
    project: "AOS",
    title: "A file capability server",
    state: "Complete",
    detail: "Proven against the real binary. It refuses a path in its own process, not Carl's.",
  },
  {
    id: "aos-runner",
    project: "AOS",
    ...
    state: "Next",
    tier: "PLANNED",
    detail: "The harder half. Nothing of it is built.",
  },
  {
    id: "bracer-research",
